...
- **Mô tả:**
  ...
  - **Bài 2:** RESTful API quản lý Contact & Requisites (Thông tin ngân hàng 3 tầng), tối ưu Bitrix24 Batch API (`/rest/batch.json`), Swagger UI (`/docs`), x-api-key Guard, Unit Tests (Lines Coverage, Single-Flight OAuth Mutex).
